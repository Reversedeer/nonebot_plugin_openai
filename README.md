...
此版本与前一版本相同，不同点为增加了被风控时的解决办法

重要！！！此版本为当你账号被风控而无法发送长消息时，经测试只需发送字符<80 即可正常发送，其他没有变化
重要！！！此版本为当你账号被风控而无法发送长消息时，经测试只需发送字符<80 即可正常发送
重要！！！此版本为当你账号被风控而无法发送长消息时，经测试只需发送字符<80 即可正常发送
重要的事情说三遍
...
## 关于openai:
    ...
    6. 这个模块貌似不是免费的, 注册的账号只有$18.00的免费额度, 有大佬调用了大约1500回, 目前的额度 $7.05 / $18.00
